...
namespace MetroSet.UI.Animates
{
	...
	public abstract class AnimateBase<T> : IDisposable
	{
		/// <summary>
		...
		public AnimateBase(int updateInterval = 16)
		{
		...
		public void Setting(int duration, T initial, T end, EasingType easing = Enums.EasingType.Linear)
		{
